#ifndef SCALARINTEGRATOR_H
#define SCALARINTEGRATOR_H
...
class ScalarIntegrator : public Integrator {
 protected:
  SplineWeb *D, *Dp;   //!< scalar sources web
  vector<Spline*> source,sourceP;
 public:

  ScalarIntegrator(Cosmos *c,double,double,SplineWeb* d, SplineWeb *dp);
  ~ScalarIntegrator();
